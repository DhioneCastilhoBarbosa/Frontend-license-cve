...
const EDITABLE_STATUSES = ["Ativada", "Criada"] as const;
...
interface EditKeyStatusModalProps {
  isOpen: boolean;
  onClose: () => void;
  nome: string;
  chave: string;
...
export default function EditKeyStatusModal({
  isOpen,
  onClose,
  nome,
  chave,
          ...
          <Dialog.Description className="text-sm text-gray-600 dark:text-gray-400 space-y-3">
            ...
            <div className="space-y-1.5 pt-1">
              ...
              <select
                ...
                value={status}
                onChange={(e) =>
                  setStatus(e.target.value as (typeof EDITABLE_STATUSES)[number])
                }
                disabled={loading}
